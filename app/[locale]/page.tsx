...
export default async function HomePage({
  ...
  const reviewsNoun: Record<string, string> = {
    es: 'opiniones',
    fr: 'avis',
    en: 'reviews',
    it: 'recensioni',
  ...
  const reviewsNounLabel = reviewsNoun[locale] || reviewsNoun.es;
          ...
          <FadeIn>
            ...
            {reviewStats.count > 0 && (
              <div className="flex items-center justify-center gap-2 mb-8 md:mb-12">
                <span className="text-xl text-yellow-500 leading-none" aria-hidden="true">
                  ★★★★★
                </span>
                ...
                <span className="text-sm text-text-secondary">
                  · {reviewStats.count} {reviewsNounLabel}
                </span>
              </div>
            )}
          </FadeIn>
