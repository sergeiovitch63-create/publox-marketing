...
export default async function ContactoWhatsAppPage({
  params,
}: {
  ...
  const t = await getTranslations('pages.contactoWhatsapp');

  return (
    <>
      <Section bgColor="soft-beige" className="py-20 md:py-24 lg:py-28 relative">
        {/* Back Button */}
        <BackButton fallbackHref={`/${locale}/contacto`} />
        <Container>
